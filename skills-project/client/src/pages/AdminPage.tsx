...
const AdminPage = () => {
  ...
  const [users, setUsers] = useState([
    { id: 1, username: 'john_doe', email: 'john@example.com', role: 'admin', status: 'active', joinDate: '2023-01-15', skills: 8, downloads: 12456 },
    { id: 2, username: 'jane_smith', email: 'jane@example.com', role: 'user', status: 'active', joinDate: '2023-02-20', skills: 3, downloads: 4231 },
    { id: 3, username: 'bob_wilson', email: 'bob@example.com', role: 'user', status: 'inactive', joinDate: '2023-03-10', skills: 12, downloads: 8765 },
  ]);
              ...
              <div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div className="bg-card rounded-lg border p-6">
                    ...
                    <div className="space-y-4">
                      {skills.filter(skill => skill.status === 'pending').map(skill => (
                        ...
                        <tr key={user.id} className="border-t">
                          ...
                          <td className="py-3 px-4">
                            <span className={`px-2 py-1 rounded-full text-xs ${
                              ...
                              {t(`admin.user.${user.status}`)}
                            </span>
                          </td>
                          <td className="py-3 px-4">{user.skills}</td>
                          <td className="py-3 px-4">{user.downloads.toLocaleString()}</td>
